function loadCustomers() {
    ...
    $.ajax({
        url: 'http://localhost:8080/cust/getAllCustomers',
        type: 'GET',
        headers: {
...
function setCustomerName() {
    ...
    $.ajax({
        url:'http://localhost:8080/sale/save',
         type: 'GET',
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
        },
...
function loadItem() {
    ...
    $.ajax({
        url: 'http://localhost:8080/inventory/getAllItem',
        type: 'GET',
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
        },
...
function setItemName() {
    ...
    $.ajax({
        url:'http://localhost:8080/inventory/searchName/${id}' ,
        type: 'GET',
